...
if __name__ == '__main__':
    ...
    # Change route set TX
    #######################################
    print(sband_fp.get_cmd_time('utc') + ": Changing the routes")

    sband_fp.printline('cmp route_set 1 2000 30 8 CAN')
    sband_fp.printline('cmp route_set 8 1000 30 255 SL0')
    ...
    sband_fp.delay(5)
    # Change route set back
    #######################################
    print(sband_fp.get_cmd_time('utc') + ": Changing the routes back")

    sband_fp.printline('cmp route_set 1 2000 30 5 CAN')
    sband_fp.delay(5)
