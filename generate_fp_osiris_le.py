...
def argumentsParser():
    ...
    parser.add_argument('-f', metavar='file', type=str, default='laserlink.fp',
    ...
    parser.add_argument('--bcn_name', '-b', type=str, action='store', default='laser_op',
...
if __name__ == '__main__':
    ...
    location = np.array([4206093, 824082, 4708434])
    ...
    # Power on laser
    ####################################### 
    print(sband_fp.get_cmd_time('utc') + ": POWER ON Laser")

    sband_fp.printline("eps node 2")
    sband_fp.printline("eps output 3 0 1000")
    sband_fp.printline("eps output 3 1 0")
    ...
    # Power on SDR and ANTENNA
    ####################################### 
    print(sband_fp.get_cmd_time('utc') + ": POWER ON SDR and ANTENNA")
    ...
    sband_fp.printline('rparam set gain -50')
    sband_fp.printline('rparam send')
    #if enable_mockup == False:
    ...
    # Power off laser
    ####################################### 
    print(sband_fp.get_cmd_time('utc') + ": POWER OFF Laser")

    sband_fp.printline("eps output 3 0 0")
    sband_fp.delay(30)
    ...
    # Power off SDR and ANTENNA
    ####################################### 
    print(sband_fp.get_cmd_time('utc') + ": POWER OFF SDR and ANTENNA")
